    ...
    try {
      ...
      if (cached) {
        ...
        if (Date.now() - ts < 60_000) {
          // Hydrates from a localStorage quote cache before deciding whether to fetch.
          // localStorage is an external system and reading it is what this effect is
          // for; the alternative is a fetch on every mount that the cache exists to
          // avoid.
