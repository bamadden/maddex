...
const COUNTRY_NAMES = {
  ...
  31:'Azerbaijan', 32:'Argentina', 36:'Australia', 40:'Austria', 44:'Bahamas', 48:'Bahrain',
  50:'Bangladesh', 52:'Barbados', 56:'Belgium', 64:'Bhutan', 68:'Bolivia', 70:'Bosnia-Herzegovina',
  72:'Botswana', 76:'Brazil', 84:'Belize', 86:'British Indian Ocean Territory', 90:'Solomon Islands',
  96:'Brunei', 100:'Bulgaria', 104:'Myanmar', 108:'Burundi', 112:'Belarus', 116:'Cambodia',
  ...
  174:'Comoros', 175:'Mayotte', 178:'Republic of Congo', 180:'DR Congo', 184:'Cook Islands',
  ...
  268:'Georgia', 270:'Gambia', 276:'Germany', 288:'Ghana', 292:'Gibraltar', 300:'Greece',
  308:'Grenada', 316:'Guam', 320:'Guatemala', 324:'Guinea', 328:'Guyana', 332:'Haiti',
  336:'Vatican City', 340:'Honduras', 344:'Hong Kong', 348:'Hungary', 352:'Iceland',
  ...
  408:'North Korea', 410:'South Korea', 414:'Kuwait', 418:'Laos', 422:'Lebanon', 426:'Lesotho',
  428:'Latvia', 430:'Liberia', 434:'Libya', 438:'Liechtenstein', 440:'Lithuania', 442:'Luxembourg',
  446:'Macau', 450:'Madagascar', 454:'Malawi', 458:'Malaysia', 462:'Maldives', 466:'Mali',
  470:'Malta', 478:'Mauritania', 480:'Mauritius', 484:'Mexico', 492:'Monaco', 496:'Mongolia',
  498:'Moldova', 504:'Morocco', 508:'Mozambique', 516:'Namibia', 524:'Nepal', 528:'Netherlands',
  540:'New Caledonia', 554:'New Zealand', 558:'Nicaragua', 562:'Niger', 566:'Nigeria',
  578:'Norway', 512:'Oman', 586:'Pakistan', 591:'Panama', 598:'Papua New Guinea', 600:'Paraguay',
  604:'Peru', 608:'Philippines', 616:'Poland', 620:'Portugal', 630:'Puerto Rico', 634:'Qatar',
  638:'Réunion', 642:'Romania', 643:'Russia', 646:'Rwanda', 682:'Saudi Arabia', 686:'Senegal',
  694:'Sierra Leone', 703:'Slovakia', 705:'Slovenia', 706:'Somalia', 710:'South Africa',
  716:'Zimbabwe', 724:'Spain', 729:'Sudan', 728:'South Sudan', 740:'Suriname', 748:'Eswatini',
  752:'Sweden', 756:'Switzerland', 760:'Syria', 762:'Tajikistan', 764:'Thailand', 768:'Togo',
  776:'Tonga', 780:'Trinidad and Tobago', 788:'Tunisia', 792:'Turkey', 795:'Turkmenistan',
  800:'Uganda', 804:'Ukraine', 784:'UAE', 826:'United Kingdom', 834:'Tanzania', 840:'United States',
  858:'Uruguay', 860:'Uzbekistan', 862:'Venezuela', 704:'Vietnam', 887:'Yemen', 894:'Zambia',
  275:'Palestine', 388:'Jamaica', 174:'Comoros', 682:'Saudi Arabia',
}
...
const COUNTRY_A2 = {
  ...
  834:'TZ',840:'US',858:'UY',860:'UZ',862:'VE',704:'VN',887:'YE',894:'ZM',275:'PS',
}
...
function WorldMap({ openCountryIds, activeLayers, onCountryClick, selectedId, geoNewsItems, selectedArc, onArcClick }) {
  ...
  const getCountryName = useCallback((id) => {
    return COUNTRY_NAMES[parseInt(id)] ?? `Country ${id}`
  }, [])
...
function CountryPanel({ id, newsItems, audRates, onClose, onAskAI }) {
  const n  = parseInt(id)
  const name = COUNTRY_NAMES[n] ?? `Country ${id}`
  const detail = COUNTRY_DETAIL[n]
